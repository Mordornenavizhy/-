...
// laba2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Claba2App, CWinApp)
...
// Единственный объект Claba2App

Claba2App theApp;


// Инициализация Claba2App

BOOL Claba2App::InitInstance()
{
